...
public class LibrariesForLibsInPluginsBlock extends AbstractExternalDependencyFactory {
    ...
    public static class AndroidxLibraryAccessors extends SubDependencyFactory {
        ...
        /**
         * Dependency provider for <b>lifecycle</b> with <b>androidx.lifecycle:lifecycle-viewmodel-compose</b> coordinates and
    ...
    public static class KoinAndroidxLibraryAccessors extends SubDependencyFactory {
        ...
        /**
         * Dependency provider for <b>navigation</b> with <b>io.insert-koin:koin-androidx-navigation</b> coordinates and
         * with version reference <b>koin</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
        ...
        public Provider<MinimalExternalModuleDependency> getNavigation() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return create("koin.androidx.navigation");
        }
    ...
    public static class SquareupRetrofit2LibraryAccessors extends SubDependencyFactory implements DependencyNotationSupplier {
        private final SquareupRetrofit2CoverterLibraryAccessors laccForSquareupRetrofit2CoverterLibraryAccessors = new SquareupRetrofit2CoverterLibraryAccessors(owner);
        ...
        /**
         * Group of libraries at <b>squareup.retrofit2.coverter</b>
         *
         * @deprecated Will be removed in Gradle 9.0.
         */
        @Deprecated
        public SquareupRetrofit2CoverterLibraryAccessors getCoverter() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return laccForSquareupRetrofit2CoverterLibraryAccessors;
        }
     ...
     */
    @Deprecated
    public static class SquareupRetrofit2CoverterLibraryAccessors extends SubDependencyFactory {

        public SquareupRetrofit2CoverterLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>moshi</b> with <b>com.squareup.retrofit2:coverter-moshi</b> coordinates and
         * with version reference <b>retrofit</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
        ...
        public Provider<MinimalExternalModuleDependency> getMoshi() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return create("squareup.retrofit2.coverter.moshi");
        }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>koin</b> with value <b>3.2.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>lifecycle</b> with value <b>2.4.1</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>okhttp3</b> with value <b>5.0.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
